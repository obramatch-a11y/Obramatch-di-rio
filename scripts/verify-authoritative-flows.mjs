...
assert(appContext.includes('deleteWorkAuthoritatively'), 'exclusão de obra deve usar a API autoritativa');
assert(appContext.includes("if (!current) throw new Error('Obra não encontrada.')"), 'exclusão normal de obras deve ser preservada');
